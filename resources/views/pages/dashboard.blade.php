                        ...
                        <table class="table table-report sm:mt-2">
                            ...
                            ?>
                                <tr class="intro-x">
                                    ...
                                    <td class="text-center">+123 2343 122 1233</td>
                                    <td class="w-40">
                                        <div class="flex items-center justify-center text-theme-20"> FLY999 </div>
                                    </td>
                                    <td class="table-report__action w-56">
                                        <div class="flex justify-center items-center">
                                            <a class="flex items-center mr-3" href="#"> Today </a>
                                        </div>
                                    </td>
                                </tr>
                            <?php
                        ...
                        <div class="mt-5">
                            <div class="intro-x">
                                <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                    ...
                                    <div class="text-theme-20">+$118</div>
                                </div>
                            </div>
                            <div class="intro-x">
                                <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                    ...
                                    <div class="text-theme-21">-$28</div>
                                </div>
                            </div>
                            <div class="intro-x">
                                <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                    ...
                                    <div class="text-theme-20">+$110</div>
                                </div>
                            </div>
                            <div class="intro-x">
                                <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                    ...
                                    <div class="text-theme-20">+$47</div>
                                </div>
                            </div>
                            <div class="intro-x">
                                <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                    ...
                                    <div class="ml-4 mr-auto">
                                        ...
                                        <div class="text-gray-600 text-xs mt-0.5">29 March 2021</div>
                                    </div>
                                    <div class="text-theme-20">+$214</div>
                                </div>
                            </div>
                        ...
                        <div class="report-timeline mt-5 relative">
                            ...
                            <div class="intro-x relative flex items-center mb-3">
                                ...
                                <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                    ...
                                    <div class="text-gray-600 mt-1">Has changed <a class="text-theme-30 dark:text-theme-25" href="">Samsung Q90 QLED TV</a> price and description</div>
                                </div>
                            </div>
                            <div class="intro-x relative flex items-center mb-3">
                                <div class="report-timeline__image">
                                ...
                                <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                    ...
                                    <div class="text-gray-600 mt-1">Has changed <a class="text-theme-30 dark:text-theme-25" href="">Sony Master Series A9G</a> description</div>
                                </div>
                            </div>
                        </div>
                    </div>
